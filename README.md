# odyssey-sanity-gatsby-netlify-v8
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/tnd2c0o9/settings/api) and create a token with read rights.
